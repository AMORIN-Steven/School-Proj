...
function openModal(action, matiereId) {
    ...
    if (action === 'ajouter') {
        ...
        modalTitle.innerHTML = '<i class="bi bi-pencil me-2"></i>Modifier une matière';
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <div class="btn-group btn-group-sm">
                                <button class="btn btn-outline-primary" onclick="openModal('modifier', ${matiere.id})">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <button class="btn btn-outline-danger" onclick="supprimerMatiere(${matiere.id})">
